...
const Content = () => {
  ...
  const cudaInitialRelease = biblio.addReference(
    'Cuda 1.0 Release',
    'https://www.scientific-computing.com/press-releases/cuda-10'
  )
  const nvidiaDomination = biblio.addReference(
        ...
        children={
          <div>
            ...
            <p>
              ...
              since its inception, thanks to its use of Tch (bindings to
              ...
              control over GPU kernels; thus we decided to write our own GPU
              backend.
            </p>
            <p>
              ...
              starting with a cross-platform backend rather than solely focusing
              ...
              stands out as the most popular and well-supported Rust graphics
              library, with numerous packages built upon it. WGPU emerged as the
              optimal solution for Cross-Platform GPU programming, automatically
              targeting Vulkan, OpenGL, Metal, Direct X11/12, and WebGPU.
            </p>
            ...
            <p>
              ...
              sensitive data, as it ensures that information remains secured
            ...
            <p>
              The use of GPUs within browsers has historically been challenging,
              given the numerous limitations associated with WebGL for
              computations
              <Reference
                references={[
            ...
            <p>
              ...
              CUDA in 2007
              <Reference
                references={[cudaInitialRelease.ref(), nvidiaDomination.ref()]}
              />
              . It played a crucial role in the development of AlexNet, the
              first large-scale deep learning model that demonstrated superior
              results over classical machine learning techniques
              <Reference references={[imageNet.ref()]} />. Consequently, many
              tools have been built around NVIDIA's hardware, potentially
              leading to an industry-wide dependency that may not be
              advantageous for consumers. However, with WGPU supporting all
            ...
            <p>
              ...
              in the future, we may explore using SPIR-V pass-through with
              ...
              known as autotuning. By identifying the most performant kernels
              for the specific hardware and graphics API in use, we aim to
              streamline and enhance Burn's performance in a dynamic and
              adaptive manner.
            </p>
            <h2>Conclusion</h2>
            <p>
              ...
              fusion, autotuning, and even quantization. We are genuinely
              interested in witnessing the potential of deep learning in diverse
              areas, including video games, web, mobile, and embedded
              applications. Supporting the community's use of Burn as they
              develop new applications is highly motivating for us. We look
              forward to discovering what will be built with Burn and WGPU.
            </p>
            <h2>References</h2>
            {biblio.generate()}
          </div>
