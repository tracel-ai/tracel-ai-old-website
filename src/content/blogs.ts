...
export const aCaseForRustInDeepLearning = {
  ...
  authorsLinks: ['https://x.com/nath_simard'],
...
export const crossPlatformGpuBackend = {
  ...
  authorsLinks: ['https://x.com/nath_simard', 'https://x.com/louisfd94'],
...
export const autotuneForGpuKernels = {
  link: '/blog/autotune-for-gpu-kernels',
  ...
  authors: ['Louis Fortier-Dubois'],
  authorsLinks: ['https://x.com/louisfd94'],
  publishedDate: '2023-12-15T18:00:00.000Z',
  imageUrl: '/blog5.jpeg',
  imageUrlAlt: 'Space digital art generated by stable diffusion.',
}
