...
export class Mnist {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Mnist.prototype);
        obj.ptr = ptr;
    ...
    */
    inference(input) {
        try {
            ...
            wasm.mnist_inference(retptr, this.ptr, ptr0, len0);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('mnist_inference_web_bg.wasm', import.meta.url);
    }
    const imports = getImports();
